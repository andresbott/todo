...
lint: ## run the go linter (needs golangci-lint)
	@golangci-lint run
...
.PHONY: coverage
coverage: ## check test coverage meets the threshold (app and internal; metainfo excluded: linker-stamped vars only)
	@fail=0; \
...
##@ Running
#==========================================================================================
run: ## run against the sample file (example.md)
	@go run . example.md
